    window.addEventListener("DOMContentLoaded",()  => {
        ...
        document.getElementById('form_update_password').addEventListener('submit', function (e) {
            ...
            if (expresionRegularPassword.test(password)==false) {
                alert("La contraseña debe tener al entre 8 y 15 caracteres, al menos un dígito, al menos una minúscula y al menos una mayúscula. Puede tener otros símbolos");
                e.preventDefault();
            }
        });
    });
