...
<body>
    ...
    <form method="POST" action="../controller/ModificarUsuarioController.php" class="container_form_crud">
        ...
        <div class="col-md-6">
            ...
            <div class="container_selects_crud">
            ...
            <div class="container-btn-crud">
                <button type="submit" class="btn btn-form-crud btn-primary" name="btn-confirmar" value="ok"> Confirmar </button>
                <button type="button" class="btn btn-form-crud btn-primary" onclick="window.location.href='../views/crud.php';"> Cancelar </button>
