        ...
        <fieldset class="fieldset_perfil_usuario">
             ...
             <div class="columnas_perfilUsu">
                ...
                <div class="inputs_perfilUsu">
                    ...
                    <input type="text" class="form_control_perfilUsu" name="correo" required>
                </div>

                <div class="inputs_perfilUsu">
                    <label for="validationCustom01" class="label_perfilUsu">Numero de documento</label>
                    <input type="number" class="form_control_perfilUsu" name="correo" required>
                </div>
            ...
            <div class="columnas_perfilUsu">
                ...
                <div class="inputs_perfilUsu">
                    <label for="validationCustom01" class="label_perfilUsu">Parqueadero asignado</label>
                    <input type="text" class="form_control_perfilUsu" name="correo" required>
                </div>
